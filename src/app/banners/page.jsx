  ...
  <div className="container relative z-10">
    <div className="grid gap-8 md:grid-cols-2 md:gap-12 items-center">
      ...
      <div className="space-y-6">
        <h1 className="text-4xl font-bold tracking-tight text-[#4285F4] sm:text-5xl">
          Banners que Impactan
        </h1>
        <p className="text-lg md:text-xl text-gray-700">
          Calidad premium en cada impresión. PET liso, UV sectorizado o tradicional.
        </p>
        <Link href="https://wa.me/+50766340008" target="_blank" rel="noopener noreferrer">
